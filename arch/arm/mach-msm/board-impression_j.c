...
int oneseg_power(int on)
{
	...
	oneseg_1v2_en_enable("8921_l28", 1200000, &reg_8921_l28);
        ...
        oneseg_antenna_matrix_power_enable("8921_l15", 2850000, &reg_8921_l15);
...
static void __init impression_j_common_init(void)
{
	...
	clk_ignor_list_add("msm_sdcc.4", "core_clk", &impression_j_clock_init_data_xa);
	
	msm_clock_init(&impression_j_clock_init_data_xa);
